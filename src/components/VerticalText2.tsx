export const verticalText = (function() {
    const trimming = function(pixels: ImageData) {
    ...
    return function(font: string, color: string, text: string, tateMargin = 4, letterSpacing = 4) {
        ...
        // const scale = 0.01; // ← ここに希望の倍率を入れる（引数化してもよい）

        // resultCanvas.width = tmpCanvas2.width * scale;
        // resultCanvas.height = tmpCanvas2.height * scale;

        // resultContext.scale(scale, scale);
        // resultContext.drawImage(tmpCanvas2, 0, 0);
