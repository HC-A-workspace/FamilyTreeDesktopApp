...
app.whenReady().then(() => {
  ...
  ipcMain.handle(
    "open-editor",
    (_, data: { personData: PersonData; tags: string[] }) => {
      ...
      editorWindow.webContents.once("did-finish-load", () => {
        editorWindow.webContents.send("load-person-on-editor", data);
      });
  ...
  ipcMain.on(
    ...
    (
      ...
      mainWindow.webContents.send("send-persondata-to-main", data);
    }
  );
